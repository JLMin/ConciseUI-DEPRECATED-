...
-- CUI ======================================================================= 
local cui_HideVanilaGossip:boolean = not CuiSettings:GetBoolean(CuiSettings.HIDE_GOSSIP_LOG);
local cui_HideVanilaCombat:boolean = not CuiSettings:GetBoolean(CuiSettings.HIDE_COMBAT_LOG);
function CuiLogReset()
  cui_HideVanilaGossip = not CuiSettings:GetBoolean(CuiSettings.HIDE_GOSSIP_LOG);
  cui_HideVanilaCombat = not CuiSettings:GetBoolean(CuiSettings.HIDE_COMBAT_LOG);
end
