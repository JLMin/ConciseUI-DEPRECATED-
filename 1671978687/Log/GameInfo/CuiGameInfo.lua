...
local function LoadInstalledMods()
  ...
  for _, mod in ipairs(mods) do
    if mod.Id ~= Tutorial and mod.Source == "Mod" then
      ...
      if mod.Official then CuiGameInfo.InstalledOff = CuiGameInfo.InstalledOff + 1;
                      else CuiGameInfo.InstalledCom = CuiGameInfo.InstalledCom + 1;
      end
...
local function LoadActiveMods()
  ...
  for _, mod in ipairs(mods) do
    ...
    if mod.Id ~= Tutorial and mod.Source == "Mod" then
      ...
      if mod.Official then CuiGameInfo.ActiveOff = CuiGameInfo.ActiveOff + 1;
                      else CuiGameInfo.ActiveCom = CuiGameInfo.ActiveCom + 1;
      end
