...
function ViewResourcesPage()  
  ...
  local cui_ShowStrategic = CuiSettings:GetBoolean(CuiSettings.SHOW_STRATEGIC);
  local cui_ShowLuxury    = CuiSettings:GetBoolean(CuiSettings.SHOW_LUXURY);
  local cui_ShowBonus     = CuiSettings:GetBoolean(CuiSettings.SHOW_BONUS);
  -- CUI: sort resources
