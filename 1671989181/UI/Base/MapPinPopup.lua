...
local defaultIcons =
{
  { icon = "ICON_MAP_PIN_STRENGTH" },
  { icon = "ICON_MAP_PIN_RANGED"   },
  { icon = "ICON_MAP_PIN_BOMBARD"  },
  { icon = "ICON_MAP_PIN_DISTRICT" },
  { icon = "ICON_MAP_PIN_CHARGES"  },
  { icon = "ICON_MAP_PIN_DEFENSE"  },
  { icon = "ICON_MAP_PIN_MOVEMENT" },
  { icon = "ICON_MAP_PIN_NO"       },
  { icon = "ICON_MAP_PIN_PLUS"     },
  { icon = "ICON_MAP_PIN_CIRCLE"   },
  { icon = "ICON_MAP_PIN_TRIANGLE" },
  { icon = "ICON_MAP_PIN_SUN"      },
  { icon = "ICON_MAP_PIN_SQUARE"   },
  { icon = "ICON_MAP_PIN_DIAMOND"  }
};
...
function PopulateIconOptions()
  ...
  -- CUI: districts icons
  if CuiSettings:GetBoolean(CuiSettings.SHOW_DISTRICT_ICONS) then
  ...
  -- CUI: wonders icons
  if CuiSettings:GetBoolean(CuiSettings.SHOW_WONDER_ICONS) then
...
function OnIconOption( iconPulldownIndex :number, notUsed :number )
  ...
  if(iconOptions) then
    local newIconName :string = iconOptions.icon;
    g_desiredIconName = newIconName;
    -- CUI: set default name
    local needSetName:boolean = CuiSettings:GetBoolean(CuiSettings.AUTO_NAMING_PINS);
    if needSetName then
...
function CuiRefresh()
  PopulateIconOptions();
  local ShowDistricts = CuiSettings:GetBoolean(CuiSettings.SHOW_DISTRICT_ICONS);
  local ShowWonders   = CuiSettings:GetBoolean(CuiSettings.SHOW_WONDER_ICONS);
