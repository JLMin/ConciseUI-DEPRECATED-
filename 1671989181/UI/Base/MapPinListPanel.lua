...
function BuildMapPinList()
  ...
  -- CUI
  Controls.ShowDistricts:SetCheck( CuiSettings:GetBoolean(CuiSettings.SHOW_DISTRICT_ICONS) );
  Controls.ShowWonders  :SetCheck( CuiSettings:GetBoolean(CuiSettings.SHOW_WONDER_ICONS) );
  Controls.AutoNaming   :SetCheck( CuiSettings:GetBoolean(CuiSettings.AUTO_NAMING_PINS) );
  m_playerMapPins = {};
...
function CuiOnShowDistrictsClick()
  local b:boolean = Controls.ShowDistricts:IsChecked();
  CuiSettings:SetBoolean(CuiSettings.SHOW_DISTRICT_ICONS, b);
  LuaEvents.CuiMapPinSettingChange();
end

-- CUI =======================================================================
function CuiOnShowWondersClick()
  local b:boolean = Controls.ShowWonders:IsChecked();
  CuiSettings:SetBoolean(CuiSettings.SHOW_WONDER_ICONS, b);
  LuaEvents.CuiMapPinSettingChange();
end

-- CUI =======================================================================
function CuiOnAutoNamingClick()
  local b:boolean = Controls.AutoNaming:IsChecked();
  CuiSettings:SetBoolean(CuiSettings.AUTO_NAMING_PINS, b);
end

-- CUI =======================================================================
function CuiOnToggleMapPin()
  -- map pin panel and button
  local pinListPanel :table = ContextPtr:LookUpControl("/InGame/MinimapPanel/MapPinListPanel");
  pinListPanel:SetHide(false);
  local pinListButton:table = ContextPtr:LookUpControl("/InGame/MinimapPanel/MapPinListButton");
	pinListButton:SetSelected(true);

  -- map options panel and button
  local optionsPanel :table = ContextPtr:LookUpControl("/InGame/MinimapPanel/MapOptionsPanel");
  optionsPanel:SetHide(true);
  local optionsButton:table = ContextPtr:LookUpControl("/InGame/MinimapPanel/MapOptionsButton");
	optionsButton:SetSelected(false);
  
  -- lens panel and button
  local lensPanel :table = ContextPtr:LookUpControl("/InGame/MinimapPanel/LensPanel");
  lensPanel:SetHide(true);
  local lensButton:table = ContextPtr:LookUpControl("/InGame/MinimapPanel/LensButton");
